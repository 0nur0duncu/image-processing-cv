...
def butterwort_low_pass_filter(f,D0,n):
  global Fshift
  M,N = f.shape
...
for index,item in enumerate(D0):
  ...
  plt.imshow(butterwort_low_pass_filter(gaussian_noise_image,item,1),cmap='gray')
...
for index,item in enumerate(n):
  ...
  plt.imshow(butterwort_low_pass_filter(gaussian_noise_image,0.3,item),cmap='gray')
